        ...
        <div class="card " style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2">
                    {{__('ui.categoria')}}: <a href="{{route('category.ads',['name'=>$ad->category->name,'id'=>$ad->category->id])}}"><button type="button" class="btn btn-light btn-xs">{{$ad->category->name}}</button></a> <br><br>
